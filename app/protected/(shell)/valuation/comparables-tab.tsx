...
import type { CompanyData, CompsData } from './valuation-types'
import { fmt, fmtMarketCap, median, Skeleton } from './valuation-shared'
...
export function ComparablesTab({ symbol }: { symbol: string }) {
